<template>
    <div class="bookmarklet_panel">
        <div class="panel_header" @click="collapsed = !collapsed">
            <span class="panel_title">书签小工具 (Bookmarklet)</span>
        ...
        <div v-show="!collapsed" class="bookmarklet_body">
...
<script setup>
import { DocumentCopy, InfoFilled, Upload, Refresh, ArrowDown } from '@element-plus/icons-vue'
